	...
	func IsImportantButton() -> some View {
		Button {
			...
			Image(systemName: "exclamationmark")
				...
				.foregroundStyle(isImportant ? styleguide.accentPrimary : styleguide.foregroundSecondary)
				.padding(8)
	...
	func ShowDateSelectionButton() -> some View {
		Button {
			...
			Image(systemName: "checkmark")
				.font(.system(.headline, design: .rounded, weight: .heavy))
				.foregroundStyle(hasDateSelected ? styleguide.foregroundPrimary : styleguide.foregroundSecondary)
				.padding(8)
				.frame(minWidth: 36, minHeight: 28)
				.background(
					.thinMaterial.shadow(.drop(color: .black.opacity(0.15), radius: 2, y: 2)),
